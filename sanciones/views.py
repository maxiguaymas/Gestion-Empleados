...
from empleados.models import Empleado, SancionEmpleado, IncidenteEmpleadoDescargo, Incidente, Sancion, Resolucion
...
def aplicar_sancion_masiva(request, incidente_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            involucrados = IncidenteEmpleadoDescargo.objects.filter(id__in=involucrados_ids)
            ...
            involucrados = IncidenteEmpleadoDescargo.objects.filter(id_incidente=incidente).select_related('id_empl')
